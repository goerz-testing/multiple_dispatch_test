...
def run_apidoc(app):
    ...
    better_apidoc.main(
        [
            ...
            os.path.join(ROOT / 'src' / 'multiple_dispatch'),
        ]
    )
...
source_suffix = '.rst'
master_doc = 'index'
project = 'Multiple Dispatch Test'
year = str(datetime.datetime.now().year)
author = 'Michael Goerz'
copyright = '{0}, {1}'.format(year, author)
version = multiple_dispatch.__version__
release = version
git_tag = "v%s" % version
...
extlinks = {
    'issue': (
        'https://github.com/goerz-testing/multiple_dispatch_test/issues/%s',
        '#',
    ),
    'pr': (
        'https://github.com/goerz-testing/multiple_dispatch_test/pull/%s',
        'PR #',
    ),
}
...
.. only:: html
    ...
    :raw-html:`<a href="http://nbviewer.jupyter.org/github/goerz-testing/multiple_dispatch_test/blob/<<GIT_TAG>>/{{ docname }}" target="_blank"><img alt="Render on nbviewer" src="https://img.shields.io/badge/render%20on-nbviewer-orange.svg" style="vertical-align:text-bottom"></a>&nbsp;<a href="https://mybinder.org/v2/gh/goerz-testing/multiple_dispatch_test/<<GIT_TAG>>?filepath={{ docname }}}" target="_blank"><img alt="Launch Binder" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a>`
""".replace(
    '<<GIT_TAG>>', git_tag
)
