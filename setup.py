...
version = get_version('./src/multiple_dispatch/__init__.py')
...
setup(
    ...
    description=("Experimental implementation of multiple dispatch"),
    python_requires='>=3.8',
    ...
    package_dir={"": "src"},
    url='https://github.com/goerz-testing/multiple_dispatch_test',
    version=version,
    zip_safe=False,
)
